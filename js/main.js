// window <-- Significa janela, como se fosse o site
// document <-- Significa Documento, como se fosse o documento do window, no caso o conteudo do site
// window.document... <-- Busca por documentos dentro do site
// .getElementsByTagName('{x}') <-- Busca por elementos no document com a tag de nome {x}
// 
// 
// 
// 
